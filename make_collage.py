...
文字カード(make_text_card.py)とサイズを揃え、9:16(1080x1920)の縦型キャンバスで出力する。
Xの画像添付は1ツイートにつき最大4枚のため、この画像1枚には最大4作品まで収める
(超過分は投稿文の本文テキスト側で確認できる)。
"""
import io
import os
...
def make_collage(items, service):
    ...
    戻り値: 1080x1920(9:16)のPNG画像bytes。有効なサムネイルが1枚もなければNone。
    """
